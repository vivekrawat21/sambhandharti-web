    ...
    <div className="container mx-auto p-4 min-h-screen">
      ...
      <div className={`flex flex-col md:flex-row items-start justify-between h-auto px-4 space-y-10 md:space-y-0 md:space-x-10`}>
        ...
        <div className="w-full md:w-1/2">
          <Image
            src="https://media.istockphoto.com/id/1325578537/photo/happy-indian-mother-having-fun-with-her-daughter-outdoor-family-and-love-concept-focus-on-mum.jpg?s=1024x1024&w=is&k=20&c=X6ed13r_BH1qYAwUDRd9uxtZeS7RDJ5usjifJU9zp2Y="
            alt="Helping Hands"
            width={800}
            height={600}
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center md:justify-start space-y-4">
          <div className="bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-xl font-bold text-violet-600 mb-4">Upcoming Projects</h2>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-xl font-bold text-violet-600 mb-4">Projects</h2>
            <div className="grid grid-cols-1 gap-2">
              {projects.map((project) => (
                <a
                  key={project.id}
                  href={`#${project.id}`}
                  className="block p-4 bg-gradient-to-r from-violet-500 to-violet-300 text-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300"
                >
      ...
      <div className="space-y-16 mt-16 px-4 flex flex-col items-center">
        {projects.map((project) => (
          <div
            key={project.id}
            id={project.id}
          ...
          >
            <h2 className="text-3xl font-bold text-violet-600 mb-4">{project.name}</h2>
            <Image
